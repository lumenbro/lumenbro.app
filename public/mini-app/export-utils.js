    ...
    try {
      ...
      console.log('✅ Bundle decrypted successfully');
       ...
       console.log('📋 Stellar private key length:', stellarPrivateKey.length);
        ...
        // S-address format is base58check encoded private key with 'S' prefix
        // For now, we'll use the hex format which works in most wallets
        const stellarSAddress = stellarPrivateKey; // Just use the hex private key directly
        console.log('📋 Stellar private key (hex):', stellarSAddress.substring(0, 20) + '...');
        console.log('📋 Stellar private key length:', stellarSAddress.length);
